...
with open('Models/bayesian_skipgram_mu_sigma_20epochs.pickle', 'rb') as handle:
    mu_sigma_dict = pickle.load(handle)
with open('Models/bayesian_skipgram_context_embeddings_20epochs.pickle', 'rb') as handle:
    context_embedding_dict = pickle.load(handle)
with open('Models/bayesian_skipgram_context_mu_sigma_20epochs.pickle', 'rb') as handle:
